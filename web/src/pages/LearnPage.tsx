...
const DOCS = [
  ...
  { label: 'README.md — 项目文档', href: 'https://github.com/jeannie-jy/Glimmer/blob/main/README.md', desc: '快速开始、API 参考、WebSocket 协议、部署指南', external: true },
  { label: 'CONTRIBUTING.md — 贡献指南', href: 'https://github.com/jeannie-jy/Glimmer/blob/main/CONTRIBUTING.md', desc: '开发环境搭建、代码规范、添加新工具与新 LLM Provider', external: true },
];
